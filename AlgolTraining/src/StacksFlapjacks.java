...
public class StacksFlapjacks{ // Chater04. 26번 문제  팬케이크 // arraylist 부분 배열 전환 sublist // Collections.reverse 해당 배열 그대로 반대 //
	public static void main(String[] args){
		...
		while(sc.hasNext()){ // 다음 입력값이 있다면 true 없으면 false
			...
			for(int j=0; j<5; j++){ // 숫자 5 말고 받아서 할 수 있게 처리 하도록
				arr.add(sc.next());
