...
public class BJ_11559_puyo3 { // BFS 뿌요뿌요 재귀 없이.
	static boolean[][] check = new boolean[12][6];
	static Queue<puyoPoint> q = new LinkedList<puyoPoint>();
	static ArrayList<puyoPoint> puyo = new ArrayList<>();
	...
	public static void bfs(int i, int j, char color) { // 좌표, 컬러값. 
		q.add(new puyoPoint(i,j));
		puyo.add(new puyoPoint(i, j));
		check[i][j] = true;
